...
Dir.chdir '/home/devin/school/chap11/destination/'

def duplicate?(filename)
    if File.exists?(filename)
        puts "ERROR Duplicate file... aborting..."
        puts "File #{filename} already exists at destination."
        exit
    else   
        false
    end
...
pic_names = Dir['/home/devin/school/chap11/source/**/*.jpg']
